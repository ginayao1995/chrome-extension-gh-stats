          ...
          <React.Fragment>
            <nav className="header">
              <img
                ...
                title="ginayao1995/chrome-extension-gh-stats"
                onClick={() => {
                  chrome.tabs.update({
              ...
              <h1>Github Stats</h1>
              <a
                className={`App-link nav-item ${currentTab === 0 ? 'active' : ''}`}
                onClick={() => setCurrentTab(0)}
              >
                A Tab
              </a>
              <a
                className={`App-link nav-item ${currentTab === 1 ? 'active' : ''}`}
                onClick={() => setCurrentTab(1)}
              >
                Another Tab
              </a>
              <a
                className={`App-link nav-item ${currentTab === 2 ? 'active' : ''}`}
              ...
              <a className="App-link" href={profileUrl} target="_blank ">
